  ...
  <meta name="keywords" content="bootstrap, bootstrap4" />
	...
	<body>
		...
		<div class="untree_co-section">
         ...
         $select_cart = mysqli_query($con, "SELECT * FROM `cart` WHERE idUser = '$id'");
         $grand_total = 0;
         if(mysqli_num_rows($select_cart) > 0){
            while($fetch_cart = mysqli_fetch_assoc($select_cart)){
         ?>
		                    <tr>
		                      <td><?php echo $fetch_cart['nomP']; ?> <strong class="mx-2">x</strong> <?php echo $fetch_cart['quantite']; ?></td>
		                      <td><?php echo $fetch_cart['prix']; ?> DH</td>
		                    
		                      
		                      <td class="text-black"><?php echo $sub_total = $fetch_cart['prix'] * $fetch_cart['quantite']; ?>DH</td>
		                    </tr>
							<?php
         ...
         ?>
		                    <tr>
		                      ...
		                      <td class="text-black font-weight-bold"><strong><?php echo $grand_total; ?> DH</strong></td>
		                    </tr>
		                  </tbody>
