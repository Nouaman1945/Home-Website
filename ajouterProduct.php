...
$(document).ready(function() {
      ...
      <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
          ...
          >
            ...
            <li>
              <a href="ajouterProduct.php" class="active">
 ...
 <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
            <div class="mb-3">
                <label for="product_name" class="form-label custom-label">Nom de Produit</label>
                <input type="text" class="form-control custom-input" id="product_name" name="product_name">
            </div>
            <div class="mb-3">
                <label for="qte" class="form-label custom-label">Quantité</label>
                <input type="number" class="form-control custom-input" id="qte" name="qte">
            </div>
            <div class="mb-3">
                <label for="product_price" class="form-label custom-label">Prix</label>
                <input type="number" class="form-control custom-input" id="product_price" name="product_price">
            </div>
            <div class="mb-3">
                <label for="formFile" class="form-label custom-label">Choisir un fichier</label>
                <input class="form-control custom-input" accept="image/png, image/jpeg, image/jpg" type="file" id="formFile" name="product_image">
            </div>
            <div class="mb-3">
...
<style>
    /* Custom styles for labels and text fields */
    .custom-label {
    ...
    .custom-input {
        max-width: 900px; /* Set maximum width for text fields */
    }
</style>
