...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Supposons que vous avez un identifiant d'utilisateur stocké dans une variable de session
    ...
    // Préparer la requête SQL d'insertion avec la clé étrangère
    $sql = "INSERT INTO contact (idUser, fname, lname, email, message, unique_key) VALUES ('$idUser', '$fname', '$lname', '$email', '$message', '$unique_key')";

    // Exécuter la requête
    if ($con->query($sql) === TRUE) {
         echo '<script>alert("Le message a été envoyé avec succès.");</script>';
        
    } else {
        echo "Erreur lors de l'ajout du contact : " . $con->error;
    }
